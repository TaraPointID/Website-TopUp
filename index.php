...
<head>
	...
	<title>Tara Point 🎮</title>
	<meta name="description" content="Tara Point adalah situs belanja online untuk pelanggan yang berfokus pada transaksi penjualan produk virtual seperti item game, akun game, dan mata uang permainan video game serta berbagai jenis voucher game.">
					...
					<div class="row">
						<div class="col-md-4 offset-md-4 col-7">
							<div class="logo text-md-center">
								<a href="index.html"><img src="./public/img/Tara Point/Logo Topup.png" alt="" /></a>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title text-center">
							<h2 class="title-border">Tara Point 🎮 Kamu Sekarang</h2>
						</div>
					</div>
				</div>
				<div class="row">
							...
							<div class="tab-pane active" id="new-arrivals">
								<div class="row">
									...
									<div class="single-product col-xl-3 col-lg-4 col-md-6">
										<div class="product-img">
											<span class="pro-label sale-label">Sale</span>
											<a href="https://template.hasthemes.com/hurst-v1/hurst/single-product.html"><img src="./public/img/Tara Point/genshin.jpg" alt="" /></a>
											<div class="product-action clearfix">
												<a href="https://template.hasthemes.com/hurst-v1/hurst/wishlist.html" data-bs-toggle="tooltip" data-placement="top" title="Wishlist"><i class="zmdi zmdi-favorite-outline"></i></a>
												<a href="index.html#" data-bs-toggle="modal" data-bs-target="#productModal" title="Quick View"><i class="zmdi zmdi-zoom-in"></i></a>
												<a href="index.html#" data-bs-toggle="tooltip" data-placement="top" title="Compare"><i class="zmdi zmdi-refresh"></i></a>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-3">
							<div class="single-footer">
								...
								<p><b>Tara Point </b>adalah situs belanja online untuk pelanggan yang berfokus pada transaksi penjualan produk virtual seperti item game, akun game, dan mata uang permainan video game serta berbagai jenis voucher game.</p>
							</div>
						</div>
					</div>
				</div>
